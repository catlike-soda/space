...
<p align="center">
  <sub>🔗 <a href="http://47.103.100.87">http://47.103.100.87</a>（阿里云上海 · 国内秒开）</sub>
  <br>
...
```
HTML/CSS/JS → Python Flask → SQLite → DeepSeek AI → Render
```
...
学日语时发现了「[识日](https://apps.apple.com/cn/app/id6738333132)」这个 App，界面精致功能强大。
...
**🔍 查词**
1. 打开搜索标签
2. 选择 `한국어 → 中文` 或 `中文 → 한국어`
3. 输入词 → 点击结果 → 查看详情
4. 切换「活用形」「例句」「关联词」

**📝 句子分析**
1. 打开「文章分析」标签
2. 输入韩语句子（如 `저는 학교에 갔어요`）
3. 点「分析句子」
4. AI 拆解单词 + 语法标注 + 翻译
